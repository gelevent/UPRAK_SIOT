            ...
            <div class="card">
                <div class="table-responsive">
                    <table class="table table-vcenter card-table table-striped">
                        ...
                        <tbody>
                            <?php $__empty_1 = true; $__currentLoopData = $sensor; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr>
                                    <td class="text-center"><?php echo e($loop->iteration + ($sensor->currentPage() - 1) * $sensor->perPage()); ?></td>
                                    <td><?php echo e($item->nama_sensor); ?></td>
                                    <td class="text-secondary"><?php echo e($item->data); ?></td>
                                    <td class="text-secondary"><?php echo e($item->topic); ?></td>
                                    <td class="text-center">
                                        <div class="btn-group gap-2">
                                            ...
                                            <!-- Tombol Hapus -->
                                            <form action="<?php echo e(route('sensor.delete', $item->id)); ?>" method="POST"
                                ...
                                <div class="modal modal-blur fade" id="modal-edit-<?php echo e($item->id); ?>" tabindex="-1" aria-hidden="true">
                                    <div class="modal-dialog modal-md modal-dialog-centered">
                                        <div class="modal-content">
                                            ...
                                            <form action="<?php echo e(route('sensor.update', $item->id)); ?>" method="POST">
                                                <?php echo csrf_field(); ?>
                                                ...
                                                <div class="modal-body">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control" name="nama_sensor"
                                                            value="<?php echo e($item->nama_sensor); ?>" required>
                                                    </div>
                                                    <div class="mb-3">
                                                        <label class="form-label">Data</label>
                                                        <input type="number" class="form-control" name="data"
                                                            value="<?php echo e($item->data); ?>" required>
                                                    </div>
                                                    <div class="mb-3">
                                                        <label class="form-label">Topic</label>
                                                        <input type="text" class="form-control" name="topic"
                                                            value="<?php echo e($item->topic); ?>" required>
                                                    </div>
                                                </div>
                ...
                <div class="d-flex justify-content-center m-3">
                    <?php echo e($sensor->links('vendor.pagination.bootstrap-5')); ?>
    ...
    <div class="modal modal-blur fade" id="modal-tambah-sensor" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-md modal-dialog-centered">
            <div class="modal-content">
                ...
                <form action="<?php echo e(route('sensor.store')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                    <div class="modal-body">
                        <div class="mb-3">
                            <label class="form-label">Nama Sensor</label>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Laragon2\laragon\www\UPRAK_SIOT\belajar_laravel\resources\views/sensor/index.blade.php ENDPATH**/ ?>