                    ...
                    <div class="row flex-column flex-md-row flex-fill align-items-center justify-between">
                        <div class="col">
                            <ul class="navbar-nav">
                                ...
                                <?php endif; ?>
                                <li class="nav-item <?php echo e(request()->routeIs('sensor.index') ? 'active' : ''); ?>">
                                    <a class="nav-link" href="<?php echo e(route('sensor.index')); ?>">
                                        <span class="nav-link-title"> Sensor </span>
                                    </a>
                                </li>
                                <?php if(auth()->user()->role === 'admin'): ?>
                                    <li class="nav-item <?php echo e(request()->routeIs('device.index') ? 'active' : ''); ?>">
                                        <a class="nav-link" href="<?php echo e(route('device.index')); ?>">
                            ...
                            <ul class="navbar-nav align-items-center">
                                <li class="nav-item dropdown">
                                    <a class="nav-link d-flex align-items-center" href="#" data-bs-toggle="dropdown">
                                        <span class="avatar me-2 rounded" style="background-image: url('https://ui-avatars.com/api/?name=<?php echo e(urlencode(auth()->user()->name)); ?>&background=random')"></span>
...
<?php /**PATH C:\Laragon2\laragon\www\UPRAK_SIOT\belajar_laravel\resources\views/partials/nav.blade.php ENDPATH**/ ?>